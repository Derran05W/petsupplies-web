...
export function CartDrawer({ open, onClose }: CartDrawerProps) {
  ...
  return (
    <div
      aria-hidden={!open}
      className={cn(
        'fixed inset-0 z-50 hidden lg:block',
    ...
    >
      ...
      <div
        ...
        className={cn(
          'absolute right-0 top-0 flex h-full w-full max-w-md flex-col bg-warm-50 shadow-xl transition-transform duration-300 ease-in-out',
      ...
      >
        <div className="flex items-start justify-between gap-4 border-b border-warm-200 px-6 py-4">
          <div className="flex flex-1 flex-col gap-3">
            ...
            {hasHydrated && count > 0 ? <FreeShippingProgress compact /> : null}
          </div>
          <button
            ref={closeButtonRef}
            type="button"
