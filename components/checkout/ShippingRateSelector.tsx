      ...
      {options.map((option) => {
        ...
        return (
          <label
            ...
            className={cn(
              'flex cursor-pointer items-center justify-between gap-3 rounded-tile border px-4 py-3 transition-colors duration-base ease-soft',
              checked
                ? 'bg-ink/5 border-ink'
          ...
          >
            <span className="flex items-center gap-3">
              <input
                ...
                className="size-4 accent-pine focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pine"
              />
