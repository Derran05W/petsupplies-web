...
export const FEATURED_PRODUCTS: Product[] = [
  ...
  {
    id: 'placeholder-4',
    slug: 'chicken-crunch-cat-treats',
    name: 'Chicken Crunch Cat Treats',
    description:
      'Oven-baked chicken bites with a satisfying crunch. Single-protein, grain-free, and small enough for training or an anytime reward.',
    priceCents: 1800,
    category: 'treats',
    petType: 'cat',
    images: [img('img-4-a', 'Chicken Crunch Cat Treats', true)],
    inStock: false,
    stockCount: 0,
    tags: ['single-protein', 'grain-free'],
